 ...
 */
#define ADVANCED_PAUSE_FEATURE  //LWJ
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       630        //44 (mA) RMS current. Multiply by 1.414 for peak current.
